...
variable "api_domain_name" {
  description = "API subdomain name (e.g., api-dev.resumerepublic.com)"
  type        = string
  default     = ""
}
...
# Database variables (smaller for dev)
...
variable "db_backup_retention_period" {
  ...
  type        = number
  default     = 1  # Shorter retention for dev
}
...
# Compute variables (smaller for dev)
variable "task_cpu" {
...
variable "log_retention_days" {
  ...
  type        = number
  default     = 3  # Shorter retention for dev
}
